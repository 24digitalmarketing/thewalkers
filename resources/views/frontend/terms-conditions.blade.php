    ...
    <div id="page-content">
        ...
        <div class="page section-header text-center mb-0">
            <div class="page-title">
                <div class="wrapper">
                    <h1 class="page-width">Terms & Conditions </h1>
                </div>
            </div>
        </div>
        <!-- End Page Title -->
        ...
        <div class="bredcrumbWrap bredcrumb-style2">
            <div class="container breadcrumbs">
                <a href="{{ route('frontend.index') }}" title="Back to the home page">Home</a><span
                    aria-hidden="true">|</span><span class="title-bold">Terms & Conditions </span>
            </div>
        </div>
        <!-- End Breadcrumbs -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h6 class="pb-2">PLEASE READ THE TERMS & CONDITIONS CAREFULLY OF - <a
                            href="{{ route('frontend.index') }}">WWW.ADABKARI.COM</a></h6>


                    <p class="pb-3"><a href="{{ route('frontend.index') }}"> www.adabkari.com</a> is owned and operated By
                        Adabkari Lucknowi
                        Chikanakari Store On the
                        Site, We provide users with access to clothing and accessories that can be purchased at the price
                    ...
                    <h6 class="pb-2"> ADABKARI.COM OR Adabkari Lucknowi Chikanakari Store CAN SEND THE PROMOTIONAL
                        SMS/E-MAIL/ MAKE CALLS TO THE CUSTOMERS ALREADY REGISTERED WITH ADABKARI.COM OR Adabkari
                        Lucknowi Chikanakari Store . </h6>

                    <p class="pb-3">
                        Adabkari Lucknowi Chikanakari Store reserves the right to cancel any order for any reason without
                        giving any prior notice to the customer. If any amount is paid by the customer, the amount will be
                        refunded fully,
                    </p>
                    <p class="pb-3">
                        Adabkari Lucknowi Chikanakari Store reserves the right to BLOCK/BLACKLIST any customer for any
                        reason without notice/intimation - will not accept/process order of these customers( Will refund if
                        pre-paid orders are placed by these customers without anynotice/initmation). Reasons can be many
                        including a customer returning the products frequently, customer trying to use his influence owing
                        to his position/profession, customer returning the products after use, customer not accepting COD
                        orders, cutsomer rasing a Paypal Transaction Dispute without sharing the concern with Adabkari
                        Lucknowi Chikanakri Store etc. leading to or capable of leading to a monetary/repuation loss to
                        Adabkari Lucknowi Chikanakri Store
                    </p>
                    <h5 class="pb-2">GENERAL CONDITIONS</h5>
                    <p class="pb-3">We reserve the right to refuse service to anyone for any reason at any time.
                        ...
                        You agree not to reproduce, duplicate, copy, sell, resell or exploit any product sold on our site
                        without express written permission by us.
                    </p>
                    <h5 class="pb-2">ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h5>
                    <p class="pb-3">We are not responsible if information made available on our site is not accurate,
                        complete or current.
                    ...
                    <p class="pb-3"> Price on the website accessed from outside India is higher than the prices shown to
                        visitors
                        accessing the website from within India.</p>
                    <p class="pb-3"> We shall not be liable to you or to any third-party for any modification, price
                        change, suspension
                        or discontinuance of any product.

                    </p>
                    <h5 class="pb-2">PRODUCTS</h5>
                    <p class="pb-3">Certain products may be available exclusively online through the website. These
                        products may have limited quantities and are subject to return or exchange only according to our
                        Return Policy.
                        ...
                        be accurate.
                        We reserve the right, but are not obligated, to limit the sales of our products to any person,
                        geographic region or jurisdiction. We may exercise this right on a case-by-case basis. We reserve
                        the right to limit the quantities of any products that we offer. All descriptions of products or
                        ...
                        on this site is void where prohibited. Though the sizes mentioned with the products are strictly
                        adhered to but there can be variation felt by customer between 1-2 inches as the way/placement of
                        measurement of the garments can be different.
                    ...
                    <h5 class="pb-2">ACCURACY OF BILLING AND ACCOUNT INFORMATION</h5>
                    <p class="pb-3">We reserve the right to refuse any order you place with us. We may, in our sole
                        ...
                        and/or orders that use the same billing and/or shipping address. In the event that we make a change
                    ...
                    <h5 class="pb-2">USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h5>
                    <p class="pb-3">
                    ...
                    <p class="pb-3"> You agree that your comments will not violate any right of any third-party, including
                        copyright,
                        trademark, privacy, personality or other personal or proprietary right. You may not use a false
                        e-mail address, pretend to be someone other than yourself, or otherwise mislead us or third-parties
                        as to the origin of any comments.

                        You are solely responsible for any comments you make and their
                        accuracy. We take no responsibility and assume no liability for any comments posted by you or any
                        third-party.

                    </p>
                    <h5 class="pb-2">ERRORS, INACCURACIES AND OMISSIONS</h5>
                    <p class="pb-3">
                    ...
                    <p class="pb-3">We grant you a limited license to access and make personal use of the Site and the
                        Service. This license does not include any downloading or copying of account information for the
                        benefit of another vendor or any other third party; caching, unauthorized hypertext links to the
                        Site and the framing of any Content available through the Site uploading, posting, or transmitting
                        any content that you do not have a right to make available (such as the intellectual property of
                        another party); uploading, posting, or transmitting any material that contains software viruses or
                        any other computer code, files or programs designed to interrupt, destroy or limit the functionality
                        of any computer software or hardware or telecommunications equipment; any action that imposes or may
                        impose (in our sole discretion) an unreasonable or disproportionately large load on our
                        infrastructure; or any use of data mining, robots, or similar data gathering and extraction tools.
                        You may not bypass any measures used by us to prevent or restrict access to the Site. Any
                        unauthorized use by you shall terminate the permission or license granted to you by us.</p>

                    <h5 class="pb-2">DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h5>
                    <p class="pb-3">We do not guarantee, represent or warrant that your use of our service will be
                        ...
                        In no case shall Adabkari Lucknowi Chikanakri Store, our directors, officers, employees, affiliates,
                    ...
                    <h5 class="pb-2">INDEMNIFICATION</h5>
                    <p class="pb-3">You agree to indemnify, defend and hold harmless our company and our parent,
                    ...
                    <h5 class="pb-2">SEVERABILITY</h5>
                    <p class="pb-3"> In the event that any provision of these Terms of Service is determined to be
                        ...
                        these Terms of Service, such determination shall not affect the validity and enforceability of any
                        other remaining provisions.</p>
                    <h5 class="pb-2">TERMINATION</h5>
                    <p class="pb-3">The obligations and liabilities of the parties incurred prior to the termination date
                    ...
                    <h5 class="pb-2">ENTIRE AGREEMENT</h5>
                    <p class="pb-3">The failure of us to exercise or enforce any right or provision of these Terms of
                    ...
                    <p class="pb-3"> Any ambiguities in the interpretation of these Terms of Service shall not be
                        construed against the
                        drafting party.
                    </p>
                    <h5 class="pb-2">GOVERNING LAW</h5>
                    <p class="pb-3">This Agreement, and the Privacy Policy or the documents they incorporate by reference
                        shall be governed and construed in accordance with the laws of India, with exclusive jurisdiction
                        conferred on the courts at New Delhi.</p>

                    <h5 class="pb-2">CHANGES TO TERMS OF SERVICE</h5>
                    <p class="pb-3">You can review the most current version of the Terms of Service at any time at this
                        page.
                    ...
                    <p class="pb-3">Questions about the Terms of Service should be sent to us at <a
