        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div class="d-flex justify-content-center align-items-center w-100">
                    <img src="{{ asset('admin-assets/assets/images/icons/dashboard.png') }}" class="logo-icon logo-big"
                        alt="logo icon">
                    <img src="{{ asset('admin-assets/assets/images/icons/dashboard.png') }}"
                        class="logo-icon d-none logo-sm" alt="logo icon">
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li> <a href="{{ route('admin.showComment') }}"><i class="bx bx-right-arrow-alt"></i>Comments
                            </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class="fa-solid fa-sitemap"></i>
                        </div>
                ...
                <li>
                    <a href="{{ route('admin.contactIndex') }}">
                        <div class="parent-icon"><i class="fa-solid fa-messages"></i>
                        </div>
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret"
                            ...
                            <div class="user-info ps-3">
                                <p class="user-name mb-0">News Website</p>
