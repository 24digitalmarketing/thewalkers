                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Webstories</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="col-12 p-0 mt-4">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h6 class="text-primary" style="font-size: 16px">Add Webstories</h6>
                    </div>
                    <div class="card-body">

                        <form method="POST" id="blog-form"
                            onsubmit="uploadData2('blog-form','{{ route('admin.addWebStoriesSave') }}', 'alert-box', 'btn-box-1', event)"
