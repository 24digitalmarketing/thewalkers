@extends('admin.main')
@push('title')
    <title>Edit Web Story Category</title>
@endpush
            ...
            <div class="card p-0">
                <div class="card-body p-0">
                    <div class="page-breadcrumb d-none d-sm-flex align-items-center border px-3 pt-2 pb-2 bg-light ">
                        <div class="breadcrumb-title pe-3">Edit Web Story Category</div>
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Web Story Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-0 mt-4">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h6 class="text-primary" style="font-size: 16px">Edit Web Story Category</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <form method="POST" id="blog-cat-form"
                                            onsubmit="uploadData1('blog-cat-form', '{{ route('admin.adminWebStoryCategoryUpdate', $data[0]->id) }}', 'alert-box', 'btn-box-1', event)"
