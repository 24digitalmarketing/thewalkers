@extends('admin.main')
@push('title')
    <title>Web Story Category</title>
@endpush
            ...
            <div class="card p-0">
                <div class="card-body p-0">
                    <div class="page-breadcrumb d-none d-sm-flex align-items-center border px-3 pt-2 pb-2 bg-light ">
                        <div class="breadcrumb-title pe-3">Web Story Category</div>
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Web Story Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-0 mt-4">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h6 class="text-primary" style="font-size: 16px">Add Web Story Category</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <form method="POST" id="WebStory-cat-form"
                                            onsubmit="uploadData1('WebStory-cat-form', '{{ route('admin.adminWebStoryCategorySave') }}', 'alert-box', 'btn-box-1', event)"
                            ...
                            <div class="card-header border-bottom">
                                <div class="row">
                                    <div
                                        ...
                                        <h6 class="text-primary" style="font-size: 16px">All Web Story Category</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="WebStory-category-table"
                                                        ...
                                                        <div class='font-sans-serif position-static d-inline-block'>
                                                            ...
                                                            <div class='dropdown-menu border py-2'>
                                                                <a class='dropdown-item'
                                                                    href='{{ route('admin.adminWebStoryCategoryShow', $single_data->id) }}'><i
                                                                        class='fas fa-edit text-primary'></i> Edit</a>
                                                                <a class='dropdown-item' href='#!'
                                                                    onclick="single_deleteConfirm('webstories_categories',[{{ $single_data->id }}],'false','','')"><i
